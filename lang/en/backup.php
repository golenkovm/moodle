...
$string['excludeevents'] = 'Exclude events that mark courses as modified';
$string['excludeeventshelp'] = 'Specify events that will not trigger courses to be marked as modified.';
