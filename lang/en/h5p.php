...
$string['h5p'] = 'H5P';
$string['h5pcrossorigin'] = 'H5P crossOrigin';
$string['h5pcrossorigin_help'] = 'Set this setting to \'anonymous\' if H5P content is served by an external storage (eg. CloudFront).';
