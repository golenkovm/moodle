...
class helper_test extends \advanced_testcase {
    ...
    public function test_question_remove_stale_questions_from_category() {
        ...
        $this->assertEquals(2, count($this->qcobject->get_parent_question_ids_for_category($qcat1->id)));
        $this->assertEquals(3, count($this->qcobject->get_parent_question_ids_for_category($qcat2->id)));
        ...
        $this->assertEquals(0, count($this->qcobject->get_parent_question_ids_for_category($qcat1->id)));
        $this->assertEquals(3, count($this->qcobject->get_parent_question_ids_for_category($qcat2->id)));
        ...
        $this->assertEquals(0, count($this->qcobject->get_parent_question_ids_for_category($qcat1->id)));
        $this->assertEquals(1, count($this->qcobject->get_parent_question_ids_for_category($qcat2->id)));
