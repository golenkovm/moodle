...
class task_running_testcase extends \advanced_testcase {
    ...
    public function test_adhoc_task_running() {
        ...
        $this->assertLessThanOrEqual($after, $running->adhoc[0]->startedwhen);
        $this->assertGreaterThanOrEqual($before, $running->adhoc[0]->startedwhen);
    ...
    public function test_scheduled_task_running() {
        ...
        $this->assertLessThanOrEqual($after, $running->scheduled[0]->startedwhen);
        $this->assertGreaterThanOrEqual($before, $running->scheduled[0]->startedwhen);
