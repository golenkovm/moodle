...
$string['flatten'] = 'Flatten multi-layer PDF files';
$string['flatten_help'] = 'If enabled, PDF files submitted by students will be flattened into single-layer PDF files';
