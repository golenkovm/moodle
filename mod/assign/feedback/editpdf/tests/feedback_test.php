...
class feedback_test extends \advanced_testcase {
    ...
    public function test_conversion_task() {
        ...
        // Verify that the task skipped the submission.
        $this->assertStringContainsString("Giving up on conversion as the conversion attempt limit has been exceeded", $output);
