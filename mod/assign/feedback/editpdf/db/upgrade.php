    ...
    if ($oldversion < 2022041900.01) {
        ...
        foreach ($rs as $record) {
            $data = [
                ...
                'submissionattempt' => (int)$record->submissionattempt,
            ];
            ...
            // Schedule one adhoc task per second to make sure they won't smash cron after upgrade.
            $nextruntime += 1;
        }
        $rs->close();
        ...
        // Editpdf savepoint reached.
        upgrade_plugin_savepoint(true, 2022041900.01, 'assignfeedback', 'editpdf');
    }
