...
if (!empty($defaulth5plib)) {
    ...
    $settings->add(new admin_setting_configselect('h5pcrossorigin', new lang_string('h5pcrossorigin', 'core_h5p'),
        new lang_string('h5pcrossorigin_help', 'core_h5p'), 0, [0 => '', 1 => 'anonymous']));
}
