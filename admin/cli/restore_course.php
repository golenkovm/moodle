...
Example:
\$sudo -u www-data /usr/bin/php admin/cli/restore_course.php --file=/path/to/backup/file.mbz --categoryid=1\n
EOL;
...
cli_heading("Extracting Moode backup file to: '" . $path . "'");
...
cli_heading("Restored course id: '" . $courseid . "'");
exit(0);
