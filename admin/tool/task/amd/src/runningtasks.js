...
/**
 * JavaScript for running tasks page. At the moment this just lets you refresh the current
 * running tasks.
 *
...
function buttonHandler() {
    ...
    const showError = () => {
        ...
        Notification.alert(M.util.get_string('error', 'moodle'),
            M.util.get_string('errorloading', 'tool_task'), M.util.get_string('ok', 'moodle'));
    };
